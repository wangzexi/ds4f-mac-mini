...
restore() {
    ...
    nohup env \
        ...
        -u DS4_METAL_STREAMING_EXPERT_VERIFY_HIT_BYTES \
        -u DS4_METAL_STREAMING_EXPERT_VERIFY_HIT_SKIP \
        -u DS4_METAL_REFRESH_STREAMING_EXPERT_ADDR_ON_HIT \
        -u DS4_METAL_SNAPSHOT_STREAMING_EXPERT_ADDR_TABLE \
