...
# The fixed 32K planner currently settles at about 963--966 Decode slots.  A
# 1000-slot request leaves a small planner headroom without advertising the
# historical 1800-slot diagnostic ceiling as a normal deployment size.
...
kv_cache_dir=${DS4F_SERVER_KV_CACHE_DIR:-/tmp/ds4f-mini/kv}
